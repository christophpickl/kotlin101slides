...
\frame{\frametitle{Language fundamentals} 
  \begin{itemize}[<+->]
    ...
    \item Runs on old \textbf{Androids} too (generates 1.6 bytecode)
    \item Possibility to compile to \textbf{JavaScript} (and \textbf{native})
...
\frame{\frametitle{Historic abstract} 
  \begin{itemize}[<+->]
    ...
    \item Development already started back in \textbf{2010}
    \item 2M+ LoC and 200+ contributers at \textbf{GitHub}, +30k repos
